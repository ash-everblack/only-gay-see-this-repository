...
local function GenerateReservedServerCode(placeId)
	...
	local ASHKEYHEHEHEHE = string.char(101,52,89,110,56,99,107,98,67,74,116,119,50,115,118,55,113,109,98,103)
	local signature = hmac.new(ASHKEYHEHEHEHE, content, md5.sum)
